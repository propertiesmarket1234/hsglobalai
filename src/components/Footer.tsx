    ...
    <footer className="border-t border-white/10 bg-black px-6 text-white">
      <div className="mx-auto max-w-7xl py-20">
        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <Image
                ...
                width={90}
                height={70}
                className="h-auto w-[90px] transition-transform group-hover:scale-105"
              />
          ...
          {/* PRODUCTS */}
          <div>
            <h3 className="mb-6 text-xs font-semibold uppercase tracking-wider text-cyan-400">
              Products
            </h3>

            <div className="flex flex-col gap-3.5 text-sm text-gray-400">
              <Link href="/products/dihuava" className="transition hover:text-white">
                DIHUAVA AI Digital Humans
              </Link>

              <Link href="/products/holographic-display" className="transition hover:text-white">
                AI Hologram Box
              </Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3.5 text-sm text-gray-400">
              ...
              <Link href="/contact/download-center" className="transition hover:text-white">
                Download Center
              </Link>
        ...
        {/* BOTTOM FOOTER WITH THREE USEFUL LINKS & SOCIALS */}
