...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-black/85 backdrop-blur-xl border-b border-white/10">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
        ...
        <Link href="/" className="flex flex-col items-center group">
          <Image
            ...
            height={60}
            priority
            className="h-auto w-[85px] transition-transform group-hover:scale-105"
          />
          <span className="mt-1 text-xs font-bold tracking-widest text-white uppercase group-hover:text-cyan-400 transition-colors">
            HS GLOBAL AI
          </span>
        </Link>
        ...
        <nav className="hidden items-center gap-8 md:flex">
          ...
          >
            ...
            >
              <span>Products</span>
              <svg
                className={`h-3.5 w-3.5 transition-transform ${productsDropdownOpen ? "rotate-180 text-cyan-400" : ""}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            {productsDropdownOpen && (
              <div className="absolute left-0 top-full pt-2 w-60 z-50">
                <div className="rounded-xl border border-cyan-500/30 bg-neutral-950/95 p-2 shadow-2xl backdrop-blur-xl">
                  <Link
                    href="/products"
                    className="block rounded-lg px-4 py-2 text-xs font-semibold text-gray-200 hover:bg-cyan-500/10 hover:text-cyan-300 transition-colors"
                  >
          ...
          >
            ...
            >
              ...
              <svg
                className={`h-3.5 w-3.5 transition-transform ${contactDropdownOpen ? "rotate-180 text-cyan-400" : ""}`}
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            {contactDropdownOpen && (
              <div className="absolute left-0 top-full pt-2 w-48 z-50">
                <div className="rounded-xl border border-cyan-500/30 bg-neutral-950/95 p-2 shadow-2xl backdrop-blur-xl">
                  <Link
                    href="/contact"
                    className="block rounded-lg px-4 py-2.5 text-xs font-semibold text-gray-200 hover:bg-cyan-500/10 hover:text-cyan-300 transition-colors"
                  >
                    Contact Us & HQ
                  </Link>
                  ...
                  <Link
                    ...
                    className="block rounded-lg px-4 py-2.5 text-xs font-semibold text-gray-200 hover:bg-cyan-500/10 hover:text-cyan-300 transition-colors border-t border-white/10 mt-1 pt-2"
                  >
                    Download Center
                  </Link>
                </div>
        ...
        <div className="hidden md:flex items-center gap-6">
          <Link
            href="/contact"
            className="rounded-full bg-white px-5 py-2.5 text-xs font-semibold text-black transition-all hover:bg-neutral-200 hover:shadow-[0_0_20px_rgba(255,255,255,0.3)]"
          >
            Book a Demo
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-4 border-l border-white/15 pl-6">
            ...
            <a
              ...
              className="text-gray-200 transition-colors hover:text-cyan-400 font-bold text-sm"
            >
              𝕏
            </a>
        ...
        <div className="flex md:hidden items-center gap-3">
          <Link
            href="/contact"
            className="rounded-full bg-white px-4 py-2 text-xs font-bold text-black shadow-md hover:bg-neutral-200"
          >
            Book a Demo
          </Link>
