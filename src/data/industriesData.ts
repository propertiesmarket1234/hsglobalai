...
export const industriesData: Record<string, IndustryDetail> = {
  banking: {
    ...
    capabilities: [
      ...
      },
      {
        ...
        description:
          "Automatic real-time language detection supporting 30+ spoken languages and regional dialects with natural pitch modulation.",
        icon: "🌐",
      },
      {
    ...
    useCases: [
      {
        title: "Private Wealth Management Lounges",
      ...
      {
        title: "Retail Branch Reception & Queueing",
        category: "Branch Automation",
        description:
          "Reduce lobby congestion with autonomous hologram concierges greeting visitors, scanning QR check-ins, and routing clients to bank representatives.",
        highlight: "40% Faster Check-In",
      },
      {
        title: "Mortgage & Credit Product Explainer",
        category: "Product Discovery",
        description:
          "Interactively break down complex mortgage disclosures, interest rates, and loan eligibility requirements in the customer's native language.",
        highlight: "Multilingual Instant Breakdown",
      },
    ],
    techSpecs: [
  ...
  retail: {
    ...
    heroOverview:
      "Transform static storefront displays and luxury retail floors into interactive 3D shopping experiences. Holographic brand avatars greet shoppers, demonstrate high-end watches, jewellery, apparel, and electronics, answer specs in 30+ languages, and feature instant Virtual Try-On.",
    accentColor: "from-cyan-500/20 via-sky-500/10 to-transparent",
    accentGlow: "rgba(6, 182, 212, 0.3)",
    metrics: [
    ...
    useCases: [
      {
        title: "Luxury Storefront Window Displays",
      ...
      {
        title: "Interactive Smart Mirror Fitting Kiosk",
        category: "Virtual Fitting",
        description:
          "Allow customers to try on outfits virtually without changing rooms, accelerating purchase decisions.",
        highlight: "Instant Fitting Overlay",
      },
      {
        title: "Product Launch & Flagship Store Activations",
  ...
  corporate: {
    ...
    capabilities: [
      ...
      },
      {
        ...
        description:
          "Connect global office visitors with regional department heads across 30+ languages.",
        icon: "🌐",
      },
    ],
    useCases: [
      {
        title: "Executive Headquarters Lobby Concierge",
        category: "Front-Desk AI",
        description:
          "Project a sleek 3D hologram receptionist in main corporate lobbies to greet VIP guests and streamline registration.",
        highlight: "Instant QR Check-In & Badge Printing",
      },
      {
        title: "Self-Service Employee HR Kiosk",
        category: "Internal Operations",
        description:
          "Provide 24/7 confidential employee policy answers, IT troubleshooting steps, and workplace request submissions.",
        highlight: "Private On-Device Querying",
      },
      {
        title: "Corporate Campus Onboarding Guide",
        category: "Employee Training",
        description:
          "Walk new hires through company culture, safety protocols, and office facilities via an interactive digital avatar.",
  ...
  healthcare: {
    ...
    metrics: [
      ...
      { label: "Multilingual Patient Support", value: "30+" },
    ...
    useCases: [
      ...
      {
        title: "Outpatient Clinic Intake & Queue AI",
        category: "Registration",
        description:
          "Gather preliminary patient information and manage appointment queue status to relieve busy nursing staff.",
        highlight: "50% Wait Time Reduction",
      },
      {
        title: "Pharmacy & Care Instruction Assistant",
        category: "Patient Care",
        description:
          "Explain medication schedules, dietary rules, and follow-up care steps to patients in 30+ languages.",
  ...
  tourism: {
    ...
    heroOverview:
      "Delight visitors at museums, heritage sites, national landmarks, and international expos with interactive 3D hologram tour guides. Avatars speak 30+ global languages, recite historical archives via local RAG, and bring cultural exhibits to life.",
    accentColor: "from-cyan-500/20 via-sky-500/10 to-transparent",
    accentGlow: "rgba(6, 182, 212, 0.3)",
    metrics: [
      { label: "Visitor Engagement Lift", value: "4x" },
      { label: "Spoken Global Languages", value: "30+" },
    ...
    useCases: [
      {
        title: "Museum Holographic Historical Figure Exhibits",
      ...
      {
        title: "International Expo & Country Pavilion Guides",
    ...
    techSpecs: [
      ...
      { label: "Speech Engine", value: "30+ Multilingual Speech Synthesis with Accent Adaptation" },
  ...
  education: {
    ...
    useCases: [
      ...
      {
        title: "Interactive STEM & Historical AI Lecturers",
        category: "3D EdTech",
        description:
          "Bring historical scientists (like Albert Einstein or APJ Abdul Kalam) to life in 3D holograms for physics and science lessons.",
        highlight: "Historical Scientist Avatars",
      },
      {
